...
mats = {
 ...
 "blue": make_material("Coreforge Blue", (0.1, 0.52, 0.9, 1), 0.45),
...
print(f"Coreforge AI generated scene: {SCENE_TITLE} from prompt: {PROMPT}")
`;
...
print(f"Coreforge AI added {len(created)} objects from prompt: {PROMPT}. Existing context objects: {len(EXISTING_OBJECTS)}")
`;
