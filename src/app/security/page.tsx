...
const controls = [
 ...
 { t: "Responsible disclosure", d: "security@alternusart.com · 7-day SLA for triage · bounty program for valid reports." },
];
...
export default function Security() {
 ...
 Crystal Studio handles engineering prompts, files, models, and code, so security is the foundation rather than a bolt-on.
 </p>
 </div>
 </section>
