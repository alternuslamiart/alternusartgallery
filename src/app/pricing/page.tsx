...
const tiers: PricingTier[] = [
 ...
 pm: 10,
 py: 5,
 d: "For individuals getting started with AI-assisted architecture.",
 cta: "Start Basic",
 feat: [
 "AI Chat",
 ...
 pm: 56,
 py: 48,
 d: "For creators who need AI chat and code in one workflow.",
 cta: "Upgrade to Pro",
 featured: true,
 feat: [
 "Everything in Basic",
 ...
 pm: 136,
 py: 124,
 d: "For architecture teams working together from concept to delivery.",
 ...
 pm: 256,
 py: 248,
 d: "For professional architecture, modeling, and infrastructure workflows.",
...
const compare = [
 ...
 cat: "AI tools",
 rows: [
 { f: "AI Chat", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "AI Code", v: ["-", "Yes", "Yes", "Yes"] },
 { f: "Architecture statistics", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "Image generation", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "PDF generation", v: ["Yes", "Yes", "Yes", "Yes"] },
 ],
 },
 {
 cat: "Architecture tools",
 rows: [
 { f: "Architecture Studio", v: ["-", "-", "Yes", "Yes"] },
 { f: "Studio modeling", v: ["-", "-", "-", "Yes"] },
 { f: "Floor plan generation", v: ["-", "-", "-", "Yes"] },
 { f: "Infrastructure planning", v: ["-", "-", "-", "Yes"] },
 { f: "Shared team workspace", v: ["-", "-", "Yes", "Yes"] },
 ],
 },
 {
 cat: "Access",
...
const faq = [
 ...
 a: "Basic includes AI Chat, architecture statistics, image generation, and PDF generation.",
 },
 {
