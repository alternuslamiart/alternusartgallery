...
const faq = [
  ...
  },
  {
    ...
    a: "Yes. Pro is free for verified students. Email hello@alternus.ai from a .edu address for a code.",
  },
];
              ...
              <div style={{ padding: "48px 48px", border: `1px solid ${t.faint}`, borderRadius: 12, background: t.raised, display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", boxShadow: `12px 12px 0 0 ${COBALT}` }} className="!grid-cols-1 md:!grid-cols-2">
                ...
                <div>
                  ...
                  <div style={{ display: "flex", gap: 12, marginTop: 28 }}>
                    ...
                    <a href="mailto:sales@alternus.ai" style={{ height: 46, padding: "0 22px", background: "transparent", color: t.fg, fontSize: 14, fontWeight: 700, borderRadius: 8, border: `1px solid ${t.faint}`, textDecoration: "none", display: "inline-flex", alignItems: "center" }}>
                      Email sales@
                    </a>
                  </div>
                </div>
