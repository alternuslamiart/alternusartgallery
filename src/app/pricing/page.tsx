...
const tiers: PricingTier[] = [
 ...
 pm: 10,
 py: 5,
 d: "A focused workspace for exploring ideas, developing concepts, and organizing early-stage architectural work.",
 cta: "Start Basic",
 feat: [
 "Claude AI assistant for architectural questions and project guidance",
 "Architectural metrics, area calculations, and project statistics",
 "AI-generated concept imagery and visual references",
 "Professional PDF reports and project documentation",
 ],
 },
 {
 n: "Pro",
 pm: 56,
 py: 48,
 d: "For professionals who want advanced AI reasoning, development tools, and richer design output.",
 cta: "Upgrade to Pro",
 featured: true,
 feat: [
 "Everything in Basic",
 "Claude AI for research, analysis, and design decision support",
 "OpenAI Codex for code generation, automation, and technical workflows",
 "Advanced architectural analysis, quantities, and project statistics",
 "High-quality image generation and presentation-ready PDF exports",
 ],
 },
 {
 n: "Team",
 pm: 136,
 py: 124,
 d: "A collaborative environment for architecture teams coordinating projects from concept through delivery.",
 cta: "Start Team trial",
 feat: [
 "Everything in Pro",
 "Claude AI and Codex access for every team workflow",
 "Shared Architecture Studio for coordinated design development",
 "Centralized project knowledge, files, and design references",
 "Team collaboration, review workflows, and shared workspaces",
 "Structured reports, statistics, and client-ready documentation",
 ],
 },
 {
 n: "Studio",
 pm: 256,
 py: 248,
 d: "The complete professional workspace for advanced modeling, documentation, and infrastructure planning.",
 cta: "Upgrade to Studio",
 feat: [
 "Everything in Team",
 "Claude AI and OpenAI Codex for advanced professional workflows",
 "Studio-grade 3D modeling and design development",
 "Intelligent floor plan generation and spatial planning",
 "Infrastructure analysis and connected systems planning",
 "Detailed technical documentation, reports, and PDF deliverables",
 ],
 },
];
...
const compare = [
 ...
 cat: "AI tools",
 rows: [
 { f: "Claude AI assistant", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "OpenAI Codex development tools", v: ["-", "Yes", "Yes", "Yes"] },
 { f: "Architectural analysis and statistics", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "AI image generation", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "Professional PDF documentation", v: ["Yes", "Yes", "Yes", "Yes"] },
 ],
 },
 {
 cat: "Architecture tools",
 rows: [
 { f: "Shared Architecture Studio", v: ["-", "-", "Yes", "Yes"] },
 { f: "Professional 3D modeling", v: ["-", "-", "-", "Yes"] },
 { f: "Intelligent floor plan generation", v: ["-", "-", "-", "Yes"] },
 { f: "Infrastructure systems planning", v: ["-", "-", "-", "Yes"] },
 { f: "Collaborative team workspace", v: ["-", "-", "Yes", "Yes"] },
 ],
 },
 {
 cat: "Access",
 rows: [
 { f: "Personal workspace", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "Team collaboration", v: ["-", "-", "Yes", "Yes"] },
 { f: "Priority support", v: ["-", "Yes", "Yes", "Yes"] },
 { f: "Professional workflows", v: ["-", "-", "Yes", "Yes"] },
 ],
 },
 {
 cat: "Billing",
 rows: [
 { f: "Monthly billing", v: ["$10", "$56", "$136", "$256"] },
 { f: "Yearly billing", v: ["$5", "$48", "$124", "$248"] },
 { f: "Cancel anytime", v: ["Yes", "Yes", "Yes", "Yes"] },
 { f: "USD pricing", v: ["Yes", "Yes", "Yes", "Yes"] },
 ],
 },
];
...
const faq = [
 ...
 a: "Basic includes a Claude AI architectural assistant, architectural metrics and statistics, AI-generated concept imagery, and professional PDF documentation.",
 },
 {
