          ...
          <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 32px" }}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <Link href="/os" style={{ marginTop: 36, height: 48, padding: "0 24px", background: COBALT, color: "#fff", fontSize: 14, fontWeight: 700, borderRadius: 8, textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 10 }}>Open in OS →</Link>
              </div>
