...
const sections = [
  { id: "overview",  t: "Overview",         b: "Alternus treats your data as yours. We process it only to deliver the product, we do not sell it, and we do not train shared models on it." },
  ...
  { id: "contact",   t: "Contact",          b: "privacy@alternus.ai — we respond within 72 hours, every time." },
];
