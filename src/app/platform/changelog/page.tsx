...
const log = [
  { d: "2026-04-22", v: "0.9.4", k: "feat", t: "Voice mode goes public", b: "Full-duplex voice conversations with Claude Opus 4.6. Available in all workspaces." },
  ...
  { d: "2026-03-01", v: "0.9.0", k: "feat", t: "Claude Opus 4.6 upgrade", b: "Default model upgraded. Latency −28%, tool-use accuracy +12% on internal benchmarks." },
