...
function ConversationMenu({ onAction }: { onAction: (action: string) => void }) {
  ...
  return <div role="menu" onClick={(event) => event.stopPropagation()} className="absolute right-0 top-10 z-[80] flex h-[218px] w-[195px] flex-col items-center justify-start overflow-hidden rounded-[16px] border-0 bg-[#242424] p-[6px] shadow-2xl">
