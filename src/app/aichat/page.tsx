...
function ConversationMenu({ onAction }: { onAction: (action: string) => void }) {
  ...
  return <div role="menu" onClick={(event) => event.stopPropagation()} className="absolute right-0 top-10 z-[80] flex h-[218px] w-[195px] flex-col items-center justify-center overflow-hidden rounded-[20px] border-[2px] border-[#303030] bg-[#242424] p-0 shadow-2xl">
