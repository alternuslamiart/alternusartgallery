...
const clauses = [
  { t: "Acceptance",       b: "By creating an Cerevix workspace, you agree to these terms. If you don't, don't use the service." },
  ...
  { t: "Acceptable use",   b: "Don't use Cerevix to harm others, break laws, or generate harmful content. We reserve the right to terminate workspaces that do." },
  { t: "Your content",     b: "You retain full ownership of everything you put into Cerevix. We need a minimal license to display it back to you — nothing more." },
  ...
  { t: "Availability",     b: "We target 99.9% uptime. When we don't meet it, we credit you. Check status.Cerevix.ai for the live picture." },
