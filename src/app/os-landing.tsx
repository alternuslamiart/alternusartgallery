...
const tiers = [
 ...
 {
 name: "Crystal Studio Desktop",
 price: "$79.99",
 period: "",
 desc: "The complete advanced Crystal Studio experience",
...
export default function OSLandingPage() {
 ...
 <span style={{ color: t.text }} className="text-sm font-bold tracking-widest">Crystal Studio</span>
 ...
 onMouseLeave={e => (e.currentTarget.style.background = t.accent)}
 >
 Try Crystal Studio <I d={ic.arrowRight} s={14} />
 </Link>
 <a
 href="#pricing"
 ...
 <span style={{ color: t.text }} className="text-[9px] font-bold tracking-widest">Crystal Studio</span>
 ...
 <span style={{ color: t.accentText }} className="text-[6px]">Crystal Studio</span>
 </div>
 ...
 <div><span style={{ color: t.textMuted }}>1</span> <span style={{ color: t.textSec }}>{"// Crystal Studio Code Editor"}</span></div>
 ...
 <h2 style={{ color: t.text }} className="text-3xl md:text-4xl font-bold text-center mb-4">Get Crystal Studio</h2>
 <p style={{ color: t.textSec }} className="text-center max-w-lg mx-auto mb-14">
 ...
 <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to try Crystal Studio?</h2>
 ...
 onMouseLeave={e => (e.currentTarget.style.background = t.accent)}
 >
 Launch Crystal Studio <I d={ic.arrowRight} s={14} />
 </Link>
 </div>
 </Section>
 ...
 <div className="flex flex-col gap-2">
 {[
 { label: "About Crystal Studio", href: "/about" },
 ...
 &copy; {new Date().getFullYear()} Crystal Studio. All rights reserved.
 </span>
 <div className="flex items-center gap-4">
 <span style={{ color: t.textMuted }} className="text-xs">Crystal Studio Web &middot; Crystal Studio Desktop &middot; AI Engineering</span>
 </div>
 </div>
 </div>
 </footer>
