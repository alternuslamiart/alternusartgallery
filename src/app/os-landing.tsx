...
const tiers = [
 ...
 {
 name: "Coreforge Ultra",
 price: "$79.99",
 period: "",
 desc: "The complete Coreforge experience",
...
export default function OSLandingPage() {
 ...
 <span style={{ color: t.text }} className="text-sm font-bold tracking-widest">Coreforge</span>
 ...
 onMouseLeave={e => (e.currentTarget.style.background = t.accent)}
 >
 Try Coreforge OS <I d={ic.arrowRight} s={14} />
 </Link>
 <a
 href="#pricing"
 ...
 <span style={{ color: t.text }} className="text-[9px] font-bold tracking-widest">Coreforge</span>
 ...
 <span style={{ color: t.accentText }} className="text-[6px]">Coreforge</span>
 </div>
 ...
 <div><span style={{ color: t.textMuted }}>1</span> <span style={{ color: t.textSec }}>{"// Coreforge Code Editor"}</span></div>
 ...
 <h2 style={{ color: t.text }} className="text-3xl md:text-4xl font-bold text-center mb-4">Get Coreforge OS</h2>
 <p style={{ color: t.textSec }} className="text-center max-w-lg mx-auto mb-14">
 ...
 <h2 className="text-3xl md:text-4xl font-bold mb-4">Ready to try Coreforge OS?</h2>
 ...
 onMouseLeave={e => (e.currentTarget.style.background = t.accent)}
 >
 Launch Coreforge OS <I d={ic.arrowRight} s={14} />
 </Link>
 </div>
 </Section>
 ...
 Our support team is here to help you get the most out of Coreforge OS. Browse docs, join the community, or contact us directly.
 </p>
 ...
 {[
 { label: "Try Coreforge OS", href: "/main" },
 { label: "Coreforge ART", href: "#pricing" },
 { label: "Coreforge Ultra", href: "#pricing" },
 ...
 <div className="flex flex-col gap-2">
 {[
 { label: "About Coreforge", href: "/about" },
 ...
 &copy; {new Date().getFullYear()} Coreforge. All rights reserved.
 </span>
 <div className="flex items-center gap-4">
 <span style={{ color: t.textMuted }} className="text-xs">Coreforge ART &middot; Coreforge Ultra &middot; Coreforge OS v1.0</span>
 </div>
 </div>
 </div>
 </footer>
