...
const press = [
 { by: "TechCrunch", t: "Coreforge raises seed to build the agent-native OS", d: "Apr 2026" },
 { by: "The Verge", t: "I replaced my desktop with a browser tab and it worked", d: "Mar 2026" },
 { by: "Hacker News", t: "Show HN: Coreforge OS — an OS that runs on Claude", d: "Feb 2026" },
...
export default function Press() {
 ...
 <a href="mailto:press@Coreforge.ai" style={{ height: 44, padding: "0 20px", background: COBALT, color: "#fff", fontSize: 13.5, fontWeight: 700, borderRadius: 8, textDecoration: "none", display: "inline-flex", alignItems: "center" }}>Email press@</a>
