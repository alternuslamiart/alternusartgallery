        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-stone-500 text-lg max-w-2xl mx-auto">
              Discover why art enthusiasts around the world choose Cerevix
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="bg-white p-8 border border-stone-200 hover:border-stone-400 transition-all duration-500 relative group rounded-lg">
              ...
              <div className="pt-4">
                ...
                <p className="text-stone-600 mb-6 leading-relaxed italic">
                  &quot;Cerevix made buying art online feel personal and trustworthy.
            ...
            <div className="bg-white p-8 border border-stone-200 hover:border-stone-400 transition-all duration-500 relative group rounded-lg">
              ...
              <div className="pt-4">
                ...
                <p className="text-stone-600 mb-6 leading-relaxed italic">
                  &quot;As a first-time art buyer, I was nervous about investing. The Cerevix team
