...
export function CookieConsent() {
 ...
 <div className="bg-white/95 backdrop-blur-xl rounded-2xl border border-gray-200/60 overflow-hidden">
 ...
 className="flex-1 sm:flex-initial flex items-center justify-center h-10 px-5 text-xs font-medium text-white bg-gray-900 hover:bg-gray-800 rounded-xl transition-all duration-200 hover:shadow-md"
 >
 Accept All
 </button>
 <button
