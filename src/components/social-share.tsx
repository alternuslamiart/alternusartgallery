...
export function SocialShare({ title, description, url, imageUrl }: SocialShareProps) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            className="hover:bg-purple-50 hover:border-purple-500 hover:text-purple-600 relative"
          >
            {showCopied ? (
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      {showCopied && (
        <p className="text-xs text-green-600 animate-in fade-in slide-in-from-top-2">
