    ...
    <div onClick={() => contextMenu && closeContextMenu()} onContextMenuCapture={handleContextMenu} className={`crystal-studio crystal-ui-kit crystal-studio-enter ${studioMode === "modeling" ? "crystal-modeling-mode" : ""} ${embedded ? "crystal-studio-embedded" : "fixed inset-0 z-[90]"} grid overflow-hidden bg-[#191919] text-zinc-100 ${leftOpen ? "" : "crystal-left-closed"} ${rightOpen ? "" : "crystal-right-closed"} ${alternateTheme ? "crystal-alt-theme" : ""}`}>
      ...
      {contextMenu && <div role="menu" onPointerDown={event => event.stopPropagation()} className="fixed z-[120] flex h-[256px] w-[220px] max-w-[calc(100vw-24px)] flex-col gap-1 rounded-[20px] border-[2px] border-[#303030] bg-[#242424] p-1 text-white shadow-2xl" style={{ left: contextMenu.x, top: contextMenu.y }}>
        ...
        <div className="relative">
          ...
          {contextSubmenu === "widget" && <div className="absolute left-full top-0 ml-2 flex h-[132px] w-[220px] flex-col justify-center gap-1 rounded-2xl border-[2px] border-[#303030] bg-[#242424] p-1 shadow-2xl"><button onClick={() => void runContextAction("widget")} className="h-9 min-h-9 w-full rounded-xl px-4 text-left text-sm hover:bg-[#353535]">Manage widgets</button><button onClick={() => void runContextAction("widget")} className="h-9 min-h-9 w-full rounded-xl px-4 text-left text-sm hover:bg-[#353535]">Add widget</button></div>}
        </div>
        <div className="relative">
          ...
          {contextSubmenu === "plugins" && <div className="absolute left-full bottom-0 ml-2 flex h-[132px] w-[220px] flex-col justify-center gap-1 rounded-2xl border-[2px] border-[#303030] bg-[#242424] p-1 shadow-2xl"><button onClick={() => void runContextAction("plugins")} className="h-9 min-h-9 w-full rounded-xl px-4 text-left text-sm hover:bg-[#353535]">Plugin manager</button><button onClick={() => void runContextAction("plugins")} className="h-9 min-h-9 w-full rounded-xl px-4 text-left text-sm hover:bg-[#353535]">Browse plugins</button></div>}
        </div>
      </div>}
