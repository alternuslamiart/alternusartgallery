              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  <div className="border-t mt-1 pt-1">
                    <DropdownMenuItem onClick={() => { signOut({ callbackUrl: "/" }); }} className="text-red-600 flex items-center gap-2 cursor-pointer">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mt-auto pt-8 space-y-4">
                    <Link
                      href="/pricing"
                      onClick={() => setIsOpen(false)}
                      className="flex items-center gap-2 text-lg font-medium text-blue-600 transition-colors hover:text-blue-700"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
