  ...
  return (
    ...
    <footer className="border-t bg-muted/30">
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Download App & Trustpilot - Compact Row */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-6">
          {/* Download App */}
          <div className="flex items-center gap-3">
            <p className="text-xs text-muted-foreground font-medium">Download Our App</p>
            <div className="flex gap-2">
              {/* App Store Button */}
              <div className="relative">
                <div
                  className="inline-flex items-center gap-1.5 bg-gray-800 text-white/70 px-3 py-1.5 rounded-lg cursor-not-allowed text-xs"
                ...
                <span className="absolute -top-1.5 -right-1.5 bg-amber-500 text-black text-[8px] font-bold px-1.5 py-0.5 rounded-full">
                  SOON
                </span>
              </div>
              {/* Play Store Button */}
          ...
          {/* Trustpilot */}
          <div className="flex items-center gap-3">
            <p className="text-xs text-muted-foreground font-medium">Customer Reviews</p>
            <div
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-xs text-muted-foreground pb-2">
